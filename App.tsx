...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-50 overflow-hidden relative">
      {/* Header / Toolbar */}
      <div className="flex-none z-10 bg-white border-b border-gray-200 shadow-sm">
        <div className="px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-semibold text-gray-800 tracking-tight">SmartSheets AI</h1>
          </div>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* AI Side Panel */}
        {isAIPanelOpen && (
          <div className="w-96 border-l border-gray-200 bg-white shadow-xl z-20 flex flex-col transition-all duration-300">
